...
| View booking history | `cinema:user-bookings [user_uuid]` | `cinema:user-bookings c39e7a3e-0131-4746-b617-638e9dc5e136 "M002"` |
...
| Apply promo code | `cinema:book-promo [booking_id] "promo_code"` | `cinema:book-promo B001 "SAVE10"` |
| Make payment | `cinema:book-pay [booking_id] "payment_method"` | `cinema:book-pay B001 "Credit Card"` |
| Generate QR ticket | `cinema:book-ticket [booking_id]` | `cinema:book-ticket B001` |
| Cancel booking | `cinema:book-cancel [booking_id]` | `cinema:book-cancel B001` |
